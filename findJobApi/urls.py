...
urlpatterns = [
    ...
    path("deleteJobApplication/<str:applicationId>/", delete_job_application),
    path("getOrderedJobs/<str:jobOrder>/", get_all_jobs_ordering),
    path("updateAccountInfo/<str:mail>/", update_account_info),
]
